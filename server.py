...
if serverName == 'A':
	serverSocket.connect((config.server_ipaddress, config.alice_port))
	clientName = 'a'
if serverName == 'B':
	serverSocket.connect((config.server_ipaddress, config.bob_port))
	clientName = 'b'
if serverName == 'C':
	serverSocket.connect((config.server_ipaddress, config.carol_port))
	clientName = 'c'
if serverName == 'D':
	serverSocket.connect((config.server_ipaddress, config.devon_port))
	clientName = 'd'
if serverName == 'E':
	serverSocket.connect((config.server_ipaddress, config.elizabeth_port))
	clientName = 'e'
